...
def sharpness(image, factor):
  ...
  with tf.device('/cpu:0'):
    ...
    # >  If any value in rate is greater than 1, we perform atrous depthwise convolution,
    # in which case all values in the strides tensor must be equal to 1.
    # Thus `rate` had no effect in this call to `depthwise_conv2d`
    # in the TF 1.0 version
